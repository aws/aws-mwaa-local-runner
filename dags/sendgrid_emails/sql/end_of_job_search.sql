...
WHERE 
    c.coaching_tier IN ('6 Months of Coaching', '6 Months of Coaching - MBG')
    AND c.coaching_status = 'Withdrawn'
    AND c.coaching_end_date = '{{ ds }}' - 5  -- Withdrew 5 days ago (allows for buffer)
