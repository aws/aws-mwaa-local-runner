# AWS IAM roles for EMR
# Adapted from the "IAM Role setups" section of sample code provided:
# https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/emr_cluster#bootable-cluster
